...
largest.grant.org <- org[spending == largest.grant.amount]

# Which organization received the smallest grant?
smallest.grant.org <- org[spending == smallest.grant.amount]

# How many grants were awarded in 2010?
awarded.2010 <- length(spending[grants$start_year == 2010])
